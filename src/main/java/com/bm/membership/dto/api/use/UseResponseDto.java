package com.bm.membership.dto.api.use;
...
/**
 * packageName    : com.bm.membership.dto.api.use
 * fileName       : UseRequestDto
 * author         : men16
 * date           : 2022-06-21
 * description    : 포인트 사용 응답 Dto
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
 * 2022-06-21        men16       최초 생성
 */
@Schema(description = "포인트 사용 response")
@ToString
@Setter
@Getter
@JsonNaming(value = PropertyNamingStrategies.SnakeCaseStrategy.class)
public class UseResponseDto extends UserApiResponse {
